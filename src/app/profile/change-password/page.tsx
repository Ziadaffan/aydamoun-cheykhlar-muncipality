          ...
          <div className="px-6 py-8">
            ...
            <form onSubmit={handleSubmit(handleChangePassword)} className="space-y-6">
              ...
              <div className="rounded-lg bg-blue-50 p-4">
                <h3 className="mb-2 text-sm font-medium text-blue-900">{t('profile.changePassword.passwordRequirements')}</h3>
                <ul className="space-y-1 text-xs text-blue-800">
                  <li>• {t('profile.changePassword.requirements.minLength')}</li>
                  <li>• {t('profile.changePassword.requirements.uppercase')}</li>
                  <li>• {t('profile.changePassword.requirements.lowercase')}</li>
                  <li>• {t('profile.changePassword.requirements.number')}</li>
                  <li>• {t('profile.changePassword.requirements.special')}</li>
                </ul>
              </div>
