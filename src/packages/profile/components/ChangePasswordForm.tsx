    ...
    <div className="px-6 py-8">
      ...
      <form onSubmit={handleSubmit(handleChangePassword)} className="space-y-6">
        ...
        <div className="flex flex-col gap-4 pt-4 sm:flex-row">
          <Button type="button" variant="secondary" size="md" className="w-full sm:flex-1" onClick={onCancel} disabled={isPasswordUpdating}>
            {t('common.cancel')}
          </Button>
          <Button type="submit" variant="primary" size="md" className="w-full sm:flex-1" loading={isPasswordUpdating} disabled={isPasswordUpdating}>
